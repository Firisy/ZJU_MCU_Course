...
TIME0:
    ...
    CJNE A,#01H,NEXT1_TIME0   ;如果30H不等于1，跳转到操作NEXT1_TIME0
    ;如果30H等于1，则将30H清零，返回中断
    MOV 30H,#00H
    LJMP T0_END1
    NEXT1_TIME0:CJNE A,#02H,OPERATE ;如果30H不等于2，跳转到操作OPERATE
    ;如果30H等于2，则将30H清零，返回中断
    MOV 30H,#00H
    LJMP T0_END1
K1:
    INC 30H
    MOV A,30H
    CJNE A,#03H,T0_END1  ;如果30H没三次，则返回中断
    ;30H判断按下三次，开始判断是哪一个被按下
    MOV P1,#0FH
    MOV A,P1
    CPL A
    ANL A,#0FH
